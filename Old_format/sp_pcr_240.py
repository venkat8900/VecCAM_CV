...
def train(train_dataloader,test_dataloader,i):
    ...
    for epoch in range(EPOCHS+1):
        ...
        if (valid_correct / valid_total) > max_val:
            ...
            print("saved")
            if not os.path.exists('/home/shrutihegde/Desktop/Species_PCR_240/Train/'):
                os.makedirs('/home/shrutihegde/Desktop/Species_PCR_240/Train/')
            torch.save(model,'/home/shrutihegde/Desktop/Species_PCR_240/Train/Model_'+str(i)+'.pt')
...
def visualize(true_label, predicted_label, i):
    ...
    #print(conf_mat)
    if not os.path.exists('/home/shrutihegde/Desktop/Species_PCR_240/Test/'):
        os.makedirs('/home/shrutihegde/Desktop/Species_PCR_240/Test/')
    plt.savefig('/home/shrutihegde/Desktop/Species_PCR_240/Test/CountCF_'+str(i)+'.jpg')
    ...
    if not os.path.exists('/home/shrutihegde/Desktop/Species_PCR_240/Test/'):
        os.makedirs('/home/shrutihegde/Desktop/Species_PCR_240/Test/')
    plt.savefig('/home/shrutihegde/Desktop/Species_PCR_240/Test/Model_'+str(i)+'.jpg')
...
if ifTrain:
    for i in range(1, 6):
        ...
        filename = "/home/shrutihegde/Desktop/Species_PCR_240/"

        # train
        print("In train loop")

        M1_train_datapath = filename + f"CV_2_M1/train_data_fold{i}.pt"
        M1_train_labelpath = filename + f"CV_2_M1/train_label_fold{i}.pt"
        M2_train_datapath = filename + f"CV_2_M2/train_data_fold{i}.pt"
        M2_train_labelpath = filename + f"CV_2_M2/train_label_fold{i}.npy"
        ...
        M1_val_datapath = filename + f"CV_2_M1/val_data_fold{i}.pt"
        M1_val_labelpath = filename + f"CV_2_M1/val_label_fold{i}.pt"
        M2_val_datapath = filename + f"CV_2_M2/val_data_fold{i}.pt"
        M2_val_labelpath = filename + f"CV_2_M2/val_label_fold{i}.npy"
    ...
    for i in range(1, 6):
        trained_model = torch.load('/home/shrutihegde/Desktop/Species_PCR_240/Train/Model_'+str(i)+'.pt')

        print('------------------FOLD'+str(i)+'----------------')

        M1_test_datapath = filename + f"CV_2_M1/test_data.pt"
        M1_test_labelpath = filename + f"CV_2_M1/test_label.pt"
        M2_test_datapath = filename + f"CV_2_M2/test_data.pt"
        M2_test_labelpath = filename + f"CV_2_M2/test_label.npy"
        ...
        M2_test_label = torch.tensor(M2_test_label["label"])
        ...
        out, valid, omit = test(test_dataloader, trained_model, threshold=0.4)
        ...
        plt.xticks(rotation=90)
        plt.yticks(rotation=0)
        plt.savefig('/home/shrutihegde/Desktop/Species_PCR_240/Test/Removed_CF_Fold'+str(i)+'.jpg')
