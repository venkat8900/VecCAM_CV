...
def train(train_dataloader,test_dataloader,i):
    ...
    for epoch in range(EPOCHS+1):
        ...
        if (valid_correct / valid_total) > max_val:
            ...
            print("saved")
            if not os.path.exists('/home/shrutihegde/Desktop/EfficientNet_5Fold/Species_Model/'):
                os.makedirs('/home/shrutihegde/Desktop/EfficientNet_5Fold/Species_Model/')
            torch.save(model,'/home/shrutihegde/Desktop/EfficientNet_5Fold/Species_Model/TrainModels'+str(i)+'.pt')
...
def visualize(true_label, predicted_label):
    ...
    if not os.path.exists('/home/shrutihegde/Desktop/EfficientNet_5Fold/Species_Model/'):
        os.makedirs('/home/shrutihegde/Desktop/EfficientNet_5Fold/Species_Model/')
    plt.savefig('/home/shrutihegde/Desktop/Species_t.jpg')


if not os.path.exists('/home/shrutihegde/Desktop/EfficientNet_5Fold_extra/Species_Model/'):
    iftrain=True
else:
    iftrain=False
...
if iftrain:
    for i in range(1, 6):
        ...
        test_model = torch.load('/home/shrutihegde/Desktop/EfficientNet_5Fold/Species_Model/TrainModels1.pt')
    ...
    # test
    test_model = torch.load('/home/shrutihegde/Desktop/EfficientNet_5Fold_wrong/Species_Model/TrainModels2.pt')
