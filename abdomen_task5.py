...
python abdomen.py --epochs 50 --data_path "./data/abdomen/task5_woculex_cropped/"  --test_model_path "./Save Models/abdomen/task5/" --save_path "./Save Models/abdomen/task5/"
"""
...
if iftrain:
    for i in range(1, args.fold + 1):
        ...
        train_dataloader = DataLoader(train_dataset, sampler=weighted_sampler, batch_size=24)
...
if iftest:
    ...
    for i in range(1, args.fold + 1):
        ...
        label_match=0
        label_mismatch=0
        whole_removed=[[0 for k in range(4)] for l in range(4)] # 5x5 matrix empty
